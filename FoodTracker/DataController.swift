        ...
        if json["hits"] != nil {
            ...
            for itemDictionary in results {
                ...
                if itemDictionary["_id"] != nil && itemDictionary["_id"] as String == idValue {
                    ...
                    var error:NSError?
                    var items = manageObjectContext?.executeFetchRequest(requestForUSDAItem, error: &error)
                    ...
                    if items?.count != 0 {
                        ...
                        let entityDescription = NSEntityDescription.entityForName("USDAItem", inManagedObjectContext: manageObjectContext!)
                        let usdaItem = USDAItem(entity: entityDescription!, insertIntoManagedObjectContext: manageObjectContext!)
                        ...
                        if itemDictionary["fields"] != nil {
                            ...
                            if fieldsDictionary["usda_fields"] != nil {
                                ...
                                if usdaFieldsDictionary["CA"] != nil {
                                    let calciumDic = usdaFieldsDictionary["CA"]! as NSDictionary
                                    let calciumVal:AnyObject = calciumDic["value"]!
                                    usdaItem.calcium = "\(calciumVal)"
                                }
                                else {
                                    usdaItem.calcium = "0"
                                }
